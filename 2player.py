            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    if not button:  #initially button is false and will only change if it is false
                        ...
                        player2 = Point(0,0, Planet.planets)
                        player2.x = 60
                        player2.y = 60
                    button = True  #until button is pressed down screen will not change
            else:
    ...
    if screen_change == 5:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_w:
                player2.thrustUpPressed = True

            if event.key == pygame.K_s:
                player2.thrustDownPressed = True

            if event.key == pygame.K_d:
                player2.thrustBackPressed = True

            if event.key == pygame.K_a:
                player2.thrustForwardPressed = True
        ...
        if event.type == pygame.KEYUP:
            ...
            if event.key == pygame.K_w:
                player2.thrustUpPressed = False

            if event.key == pygame.K_s:
                player2.thrustDownPressed = False

            if event.key == pygame.K_a:
                player2.thrustBackPressed = False

            if event.key == pygame.K_d:
                player2.thrustForwardPressed = False
        ...
        screen.blit(rocket, (player2.x, player2.y))
        if player2.thrustUpPressed:
            screen.blit(rocket_thrust_down, (player2.x, player2.y))
        if player2.thrustDownPressed:
            screen.blit(rocket_thrust_up, (player2.x, player2.y))
        if player2.thrustBackPressed:
            screen.blit(rocket_thrust_right, (player2.x, player2.y))
        if player2.thrustForwardPressed:
            screen.blit(rocket_thrust_left, (player2.x, player2.y))
